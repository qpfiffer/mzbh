...
dbctl: btree.o blue_midnight_wish.o utils.o dbctl.o logging.o
	$(CC) $(CLAGS) $(INCLUDES) -o dbctl $^ -lm

$(NAME): blue_midnight_wish.o btree.o grengine.o greshunkel.o utils.o logging.o server.o stack.o parse.o http.o main.o parson.o
